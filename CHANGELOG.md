...
- 修复阅读页面工具栏显隐不稳定的问题
- 修复阅读布局设置无效的问题
- 新增页眉页脚显示，显示当前章节标题、进度和总进度
- 统一阅读页面目录显示样式，可以显示设置，更方便进行阅读设置
- 优化连续滚动，更加简洁明了
- 修复快速标注选择区域不会被取消选择，导致重复添加到笔记中问题
- 修复快速标注拖拽尚未结束时已经落标
- 新增块悬浮窗打开笔记文档
- 新增自动创建笔记文档后自动绑定
- 优化了 sireader://open 链接的可读转译逻辑
- 修复本地书籍链接导入失败的问题
- 优化了导入页面分组样式，用颜色区分，更加简单明了
- 优化分组显示，显示封面为四宫格样式
- 优化书架列表视图样式布局，标签堆叠，元素tooltip
- 优化进入分组的交互，避免闪烁
- 设置新增添加时同步和删除时同步，不再单独书籍设置，全局更加便捷直观
- 修复树状视图下删除书籍无法确认的问题
- 为设置增加图标，观感更直观
- 新增批注批量导入，通过是否绑定块id判断
